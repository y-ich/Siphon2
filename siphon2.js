...
(function() {
  var API_KEY_FULL, API_KEY_SANDBOX, activeEditor, ancestorFolders, byteString, compareString, compileCS, config, dateString, dropbox, error, ext2mode, fireKeyEvent, foldFunction, getDeclaredVariables, getExtension, getList, initializeDropbox, initializeEventHandlers, isPortrait, lessParser, makeFileList, newCodeMirror, newTabAndEditor, restoreBuffer, restoreConfig, saveBuffer, setValue, showError, spinner, touchDevice, updateEditor, uploadFile;
  ...
  newCodeMirror = function(id, options, title) {
    var $wrapper, defaultOptions, key, result, value;
    defaultOptions = {
      lineNumbers: true,
  ...
  restoreConfig = function() {
    ...
    $('#key-extension').css('bottom', (_ref1 = config.keyExtensionHeight) != null ? _ref1 : '0px');
  ...
  initializeEventHandlers = function() {
    var bottom, clientStartY, cmCompiled, e, selectEnd, selectMove, selectStart, type, types, _i, _j, _len, _len1, _ref;
    ...
    $('#hold').on('touchcancel touchend', function() {
      var cm;
      cm = activeEditor();
    ...
    bottom = null;
    clientStartY = null;
    $('#key-extension').on('touchstart', function(e) {
      var event;
      event = e.originalEvent;
      bottom = parseInt($(this).css('bottom'));
      return clientStartY = event.touches[0].clientY;
    });
    $('#key-extension').on('touchmove', function(e) {
      var event;
      event = e.originalEvent;
      return $(this).css('bottom', Math.max(bottom + clientStartY - event.touches[0].clientY, 0) + 'px');
    });
    $('#key-extension').on('touchend', function(e) {
      config.keyExtensionHeight = $(this).css('bottom');
      return localStorage['siphon-config'] = JSON.stringify(config);
    });
    return $('#key-extension').on('touchcancel', function(e) {
      return $(this).css('bottom', bottom + 'px');
    });
  };
